...
const readStreem = fs.createReadStream('./hello.txt', { encoding: 'utf-8' }) /// create readstreeam 
const writeStreem = fs.createWriteStream('./world.txt', { encoding: 'utf-8' }) // create writeStreeam
